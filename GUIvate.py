...
N.title('ໂປຣເເກຣມຄຳນວນເກັບຄ່າພາສີ') # ຊື່ໂປຣເເກຣມ
...
def Nouher(event=None): # ຄື funtion ການຄຳນວນ
...
################### ປຸ່ມກົດເພືອຄຳນວນ ###############
B1 = Button(N,text='ຄຳນວນ',command=Nouher)
B1.pack(ipadx=20,ipady=10,pady=10)

U3.bind('<Return>',Nouher) # Return ເເລະ eventຄືການເຊືອມຕໍ່Enter None ຄືເພືອໃຫ້ສາມາດທຳງານໄດ້ທັ້ງສອງ 
########### ຜົນລັບຈາກການຄຳນວນ ##################
n_ຜົນລັບ = StringVar()
